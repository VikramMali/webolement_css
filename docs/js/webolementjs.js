...
class Webolement extends HTMLElement {
    constructor() {
        super();
        if (this.getData) {
                ...
                try {
                    ...
                    switch (attribute_name) {
                        ...
                        default:
                            ...
                            } else if (binding_element.data && binding_element.data[attribute_name] != undefined) {
                                if (new_value) {
                                    binding_element.data[attribute_name] = JSON.parse(JSON.stringify(new_value))
                                } else {
                                    binding_element.data[attribute_name] = new_value
                                }
                            } else if (!new_value) {
                    ...
                    console.log(binding_element.outerHTML)
                    console.log(prop)
                    console.log(error)
                }
            }
