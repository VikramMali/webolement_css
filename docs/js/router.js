class RouterView extends HTMLElement {
    ...
    on__load() {
            ...
            try {
                ...
                if (url.hostname != location.host) {
                    ...
                    if (typeof android != "undefined" && android != null) {
                        ...
                        window.webkit.messageHandlers.openLink.postMessage(inputInfo);
                    } else {
        ...
        window.webe_navigate = (path, data = false, replace = false) => {
            if(path.includes("https") && !path.includes(location.host)){
                if (typeof android != "undefined" && android != null) {
                    android.processResult(path);
                } else if (typeof window.webkit != "undefined" && window.webkit != null) {
                    let inputInfo = {
                        link : path
                    }
    ...
    async setRoute(route, data) {
        if(this.old_route && this.old_route.element == route.element){
        ...
        */
        ...
        loadwebcomponents(route.tag_name, route.component_path).then((loded) => {
            if (loded) {
                ...
                window.webepagesection = section
                if (this.firstChild) {
